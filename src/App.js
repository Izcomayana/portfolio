...
function App() {
  ...
  return (
    <div className={`App scroll-smooth  ${ toggleDarkmode && 'dark' }`}>
      <div className="body-container transition ease-in duration-550 dark:bg-[#161616]">
        <div className="container px-4 md:px-8">
          <header className=''>
            <div className="cv-link dark:text-white">
              <a href="https://docs.google.com/document/d/1BxYdgkJTpqrUSimGZCvJWUO-NzvPnZdSed9wGg1jTgw/edit#">RESUME</a>
            </div>
          ...
          <body>
            <div className="about mt-4">
              <div className="name text-center dark:text-white">
                <img className='inline' src={me} alt="" />
              ...
              <div className="intro my-8">
                <h2 className='headers sm:text-3xl'>First Of All 🤞🏽</h2>
            ...
            <div className="skills mt-16">
              <h2 className='headers sm:text-3xl'>My Skill Set 🤹</h2>
              <div className="skill-icons flex flex-wrap justify-evenly gap-5 mt-8">
            ...
            <div className="projects-container my-12">
              <h2 className="headers sm:text-3xl">What I've cooked so far 👨‍🍳</h2>
              <p className='dark:text-[#bbbbbb] sm:text-lg'>
                I try my best to make the best “meals” and here are some delicious ones🍲...
              </p>
              <div className="projects my-10 flex flex-col justify-center items-center">
        ...
        <footer className='bg-yellow text-white p-8 sm:p-14'>
